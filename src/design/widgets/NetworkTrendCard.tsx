  ...
  return (
    <Tile light={light} className="min-h-[180px] p-4">
      ...
      <div className="mt-4 flex items-end gap-2">
        <DotText value={value} className="text-[30px] @min-[300px]:text-[40px] @min-[360px]:text-[52px] leading-[0.88] tracking-[-0.03em]" />
        <p className={`pb-1 text-[18px] ${muted}`}>{unit}</p>
      </div>

      <svg className="mt-3 h-[46px] w-full" preserveAspectRatio="xMidYMid meet" viewBox="0 0 260 46">
        <path
